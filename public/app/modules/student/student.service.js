...
const getAllStudentsFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const queryObj = Object.assign({}, query); // copy of original query
    ...
    // Returning Response
    const result = yield fieldLimitingQuery.populate('admissionSemester').populate({
...
const updateStudentFromDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield student_model_1.Student.findOneAndUpdate({ id: id }, modifiedUpdatedData, { new: true, runValidators: true });
    return result;
});
